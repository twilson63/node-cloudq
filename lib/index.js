(function() {
  var VERSION, app, express, fs, queue, validJob;
  ...
  app.get('/', function(req, resp) {
    ...
    return resp.end(fs.readFileSync(__dirname + '/../public/index.html'));
  });

  app.get('/app.css', function(req, resp) {
    resp.writeHead(200, {
      'Content-Type': 'text/css'
    });
    return resp.end(fs.readFileSync(__dirname + '/../public/resources/css/app.css'));
  });

  app.get('/sencha-touch-all-debug.js', function(req, resp) {
    resp.writeHead(200, {
      'Content-Type': 'text/javascript'
    });
    return resp.end(fs.readFileSync(__dirname + '/../public/sencha-touch-all-debug.js'));
  });
  ...
  app.get('/app.js', function(req, resp) {
    ...
    return resp.end(fs.readFileSync(__dirname + '/../public/app.js'));
  });

  app.get('/queues', function(req, resp) {
